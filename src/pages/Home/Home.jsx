...
import { getMyFunding, getHomeFundingList, getFundingSummary } from '../../apis/home';
...
const Home = () => {
    ...
    const ProductGridComponent = ({ imgLink, imgSrc, altText, brand, itemName, price }) => (
        <ProductGrid>
            <ProductImg onClick={() => handleProductImgClick(imgLink)} src={imgSrc} alt={altText} />
        ...
        <MainContainer>
            ...
            <RightContainer>
                ...
                <Body>
                    ...
                    <TogetherDiv bc={theme.white}>
                            ...
                            <>
                                <BetweenDiv pt="20px" pb="10px">
                                    ...
                                    <MainBtnContainer>
                                        ...
                                        <MainBtn onClick={() => navigate(`/fundingModify/${myFunding.id}`)}>
                                            수정
                                        </MainBtn>
                                    </MainBtnContainer>
                                </BetweenDiv>
                                ...
                                >
                                    ...
                                    <BannerProgressDiv>
                                        ...
                                        <RoundProgressBar>
                                            <RoundProgress width={(myFunding.achievementRate / 100) * 100} />
                                        </RoundProgressBar>
                                    </BannerProgressDiv>
                                </BetweenDiv>
                            </>
                        ...
                        {isLoggedIn && (!myFunding || myFunding.status !== 'ACTIVE') && (
                            <>
                                ...
                                <MyFundingDiv>
                                    ...
                                    <MyFundingBtn onClick={() => navigate('/fundingcreate')}>펀딩 만들기</MyFundingBtn>
                                </MyFundingDiv>
                            </>
                        )}
                        {/* 로그아웃 상태일 때 */}
                        {!isLoggedIn && (
                            <>
                                ...
                                <MyFundingDiv>
                                    <MyFundingTitle>진행 중인 펀딩이 없어요</MyFundingTitle>
                                    <MyFundingBtn onClick={handleLoginClick}>펀딩 만들기</MyFundingBtn>
                                </MyFundingDiv>
                            </>
                        )}
                    </TogetherDiv>
                    ...
                    {/* 함께한 선물 */}
                    <TogetherBetween>
                        <P pt="40px" pb="40px" fs={theme.title} fw="600" color={theme.primary}>
                            Giftipie
                        </P>
                        <P pt="40px" pb="40px" fs={theme.title} fw="500" color={theme.white}>
                            에서 함께한 선물
                        </P>
                    </TogetherBetween>
                    <TogetherGrids>
